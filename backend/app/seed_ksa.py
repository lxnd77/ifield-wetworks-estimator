...
# (lbr_key -> (primary_coverage_per_day, secondary_coverage_per_day, inhouse_count, local_count))
LBR_COVERAGE = {
    "floor_1200x600": (14, 25, 2, 0),
    "floor_600x600": (16, 25, 2, 0),
    "floor_600x300": (18, 25, 2, 0),
    "floor_300x300": (20, 25, 2, 0),
    "floor_1200x600_20mm": (8, 25, 2, 0),
    "marble_flooring": (8, 50, 4, 0),
    "marble_cladding": (5, 50, 4, 0),
    "marble_skirting": (20, 50, 4, 0),
    "tile_skirting": (50, 50, 2, 0),
    "tile_skirting_20mm": (25, 25, 2, 0),
    "wall_1200x1200": (10, 24.3, 2, 0),
    "wall_1200x600": (12, 24.3, 2, 0),
    "wall_600x600": (12, 24.3, 2, 0),
    "wall_600x300": (14, 24.3, 2, 0),
    "gypsum_ceiling": (14, 0, 3, 0),
    "gypsum_corniche": (20, 0, 2, 0),
    "dry_wall_partition": (10, 0, 3, 0),
    "wall_punning": (15, 0, 2, 0),
    "ceiling_punning": (10, 0, 2, 0),
    "wall_paint": (18, 0, 1, 0),
    "ceiling_paint": (14, 0, 1, 0),
    "decorative_paint": (9, 0, 1, 0),
    "exterior_paint": (15, 0, 1, 0),
    "ips_30mm": (55, 0, 3, 0),
    "ips_50mm": (40, 0, 3, 0),
    "plaster": (10, 0, 1, 0),
    "waterproofing_2coat": (15, 0, 1, 0),
    "staircase_step": (15.5, 10, 2, 0),
    "staircase_skirting": (20, 20, 2, 0),
}
...
GYPSUM_ITEMIZED_BOM = {
    ...
    "RG Gypsum False ceiling": [
        ...
        ("GY MP 25/25 WA 050 3000, Wall Angle (suspension+perimeter+cove)", None, "Pcs", 0.978031, 0.0, 1.018918918918919),
...
KSA_COUNTRY = dict(
    ...
    inhouse_salary_month_local=45000.0,
